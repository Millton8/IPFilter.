...
namespace IPFilter
{
    class IPFilter
    {
        ...
        string fileLog;
        string fileOutput;
        public IPFilter(string fileLog, string fileOutput = null, string addressStart = null, uint? addressMask = null)
        {
        ...
        public void Filter()
        {
            var filteredDict = new Dictionary<IPAddress, uint>();
            bool isRight = false;
            string line;
            ...
            using (var writer = new StreamWriter(fileOutput))
            {
                ...
                {
                    writer.WriteLine($"{ipAddress.Key} Обращений {ipAddress.Value}");
                }
            }
